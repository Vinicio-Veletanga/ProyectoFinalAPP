...
a persistence unit "bancavirtualPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "bancavirtual\pom.xml":
...
artifact ("bancavirtual.war") is already built. You can build
